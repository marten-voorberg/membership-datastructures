...
// Altered version of https://algs4.cs.princeton.edu/33balanced/RedBlackBST.java.html
public class RedBlackTree implements Membership {
    ...
    private boolean isMember(Node x, int key) {
        while (x != null) {
